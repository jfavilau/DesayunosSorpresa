...
public class RepositorioProductoMysql implements RepositorioProducto {
    ...
    @SqlStatement(namespace="producto", value="buscarProductoPorId")
    private static String sqlBuscarProductoPorId;
    ...
    public Producto buscarProductoPorId(Long id) {
        ...
        return this.customNamedParameterJdbcTemplate.getNamedParameterJdbcTemplate().queryForObject(sqlBuscarProductoPorId,paramSource, new MapeoProducto());
    }
